...
class TenantRepository {
  ...
  static async destroy(id, options: IRepositoryOptions) {
    ...
    await Publication(options.database).deleteMany({ tenant: id }, options);

    await Forum(options.database).deleteMany({ tenant: id }, options);

    await DemandeAppui(options.database).deleteMany({ tenant: id }, options);

    await Evenement(options.database).deleteMany({ tenant: id }, options);

    await Thematique(options.database).deleteMany({ tenant: id }, options);

    await Tags(options.database).deleteMany({ tenant: id }, options);

    await Artiste(options.database).deleteMany({ tenant: id }, options);

    await EspaceArtistique(options.database).deleteMany({ tenant: id }, options);
